...
docker cp i2b2-data-mssql:/tmp/i2b2demodata.bak ./i2b2demodata.bak
docker cp i2b2-data-mssql:/tmp/i2b2metadata.bak ./i2b2metadata.bak
docker cp i2b2-data-mssql:/tmp/i2b2pm.bak ./i2b2pm.bak
docker cp i2b2-data-mssql:/tmp/i2b2hive.bak ./i2b2hive.bak
docker cp i2b2-data-mssql:/tmp/i2b2workdata.bak ./i2b2workdata.bak
 
 
docker cp i2b2demodata.bak i2b2-mssql:/var/opt/mssql/data/i2b2demodata.bak
docker cp i2b2metadata.bak i2b2-mssql:/var/opt/mssql/data/i2b2metadata.bak
docker cp i2b2pm.bak i2b2-mssql:/var/opt/mssql/data/i2b2pm.bak
docker cp i2b2hive.bak i2b2-mssql:/var/opt/mssql/data/i2b2hive.bak
docker cp i2b2workdata.bak i2b2-mssql:/var/opt/mssql/data/i2b2workdata.bak
 
 
docker exec -i i2b2-mssql /opt/mssql-tools/bin/sqlcmd -S $host,$port -U $username -P $password -Q  "Restore database i2b2demodata from disk = N'i2b2demodata.bak' with replace, move 'i2b2demodata' to '/var/opt/mssql/data/i2b2demodata.mdf', move 'i2b2demodata_log' to '/var/opt/mssql/data/i2b2demodata_log.ldf'"
 
docker exec -i i2b2-mssql /opt/mssql-tools/bin/sqlcmd -S $host,$port -U $username -P $password -Q  "Restore database i2b2metadata from disk = N'i2b2metadata.bak' with replace, move 'i2b2metadata' to '/var/opt/mssql/data/i2b2metadata.mdf', move 'i2b2metadata_log' to '/var/opt/mssql/data/i2b2metadata_log.ldf'"
 
 
docker exec -i i2b2-mssql /opt/mssql-tools/bin/sqlcmd -S $host,$port -U $username -P $password -Q  "Restore database i2b2pm from disk = N'i2b2pm.bak' with replace, move 'i2b2pm' to '/var/opt/mssql/data/i2b2pm.mdf', move 'i2b2pm_log' to '/var/opt/mssql/data/i2b2pm_log.ldf'"
 
 
docker exec -i i2b2-mssql /opt/mssql-tools/bin/sqlcmd -S $host,$port -U $username -P $password -Q  "Restore database i2b2hive from disk = N'i2b2hive.bak' with replace, move 'i2b2hive' to '/var/opt/mssql/data/i2b2hive.mdf', move 'i2b2hive_log' to '/var/opt/mssql/data/i2b2hive_log.ldf'"
 
 
docker exec -i i2b2-mssql /opt/mssql-tools/bin/sqlcmd -S $host,$port -U $username -P $password -Q  "Restore database i2b2workdata from disk = N'i2b2workdata.bak' with replace, move 'i2b2workdata' to '/var/opt/mssql/data/i2b2workdata.mdf', move 'i2b2workdata_log' to '/var/opt/mssql/data/i2b2workdata_log.ldf'"
